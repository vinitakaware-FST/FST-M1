...
public class Activity5 {
    ...
    public void smsTest() {
        ...
        driver.findElement(AppiumBy.id("recipient_text_view")).sendKeys("9892916811");
        // Press ENTER
        ...
        // Assertion
        String messageTextSent = driver.findElement(AppiumBy.xpath("//android.widget.TextView[contains(@text, 'Hello from Appium')]")).getText();
